            ...
            <CardContent className="p-4 md:p-6">
              <div className="flex items-center">
                ...
                <div className="ml-2 md:ml-4">
                  <p className="text-xs md:text-sm font-medium text-gray-600">Total Teams</p>
          ...
          <Card>
            <CardContent className="p-4 md:p-6">
              <div className="flex items-center">
                ...
                <div className="ml-2 md:ml-4">
                  <p className="text-xs md:text-sm font-medium text-gray-600">Participants</p>
                  <p className="text-lg md:text-2xl font-bold text-gray-900">{registrations.length * 6}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-4 md:p-6">
              <div className="flex items-center">
                ...
                <div className="ml-2 md:ml-4">
                  <p className="text-xs md:text-sm font-medium text-gray-600">National</p>
          ...
          <Card>
            <CardContent className="p-4 md:p-6">
              <div className="flex items-center">
                ...
                <div className="ml-2 md:ml-4">
                  <p className="text-xs md:text-sm font-medium text-gray-600">Female</p>
                  <p className="text-lg md:text-2xl font-bold text-gray-900">
            ...
            {registrations.length === 0 ? (
              ...
              <div className="overflow-x-auto -mx-4 md:mx-0">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead className="min-w-[120px]">Team Name</TableHead>
                      <TableHead className="min-w-[80px]">PS No.</TableHead>
                      ...
                      <TableHead className="min-w-[80px]">Female</TableHead>
                      <TableHead className="min-w-[100px] hidden lg:table-cell">Willingness</TableHead>
                      <TableHead className="min-w-[100px] hidden lg:table-cell">IP Address</TableHead>
                  ...
                  <TableBody>
                    {registrations.map((registration) => (
                      <TableRow key={registration.id}>
                        ...
                        <TableCell className="text-sm">{registration.psNumber}</TableCell>
                        <TableCell className="text-sm">
                          <div>
                            <p className="font-medium">{registration.teamLeader.name}</p>
                            <p className="text-xs text-gray-600 font-mono">{registration.teamLeader.enrollmentNo}</p>
                          </div>
                        </TableCell>
                        <TableCell className="hidden md:table-cell text-sm">
                          <div>
                            <p className="text-xs">{registration.teamLeader.contact}</p>
                            <p className="text-xs text-gray-600 break-all">{registration.teamLeader.email}</p>
                          </div>
                        </TableCell>
                        <TableCell>
